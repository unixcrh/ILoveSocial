...
{
    NewFeedSelfListController* userList;
...
-(void)processRenrenData:(NSArray*)array
{
    for(NSDictionary *dict in array) {
        ...
        if (([[dict objectForKey:@"feed_type"] intValue]==20)||([[dict objectForKey:@"feed_type"] intValue]==21))
        {
            ...
            NewFeedBlog* data = [NewFeedBlog insertNewFeed:0  height:scrollHeight  getDate:_currentTime  Owner:self.processRenrenUser  Dic:dict inManagedObjectContext:self.managedObjectContext];
        ...
        else if ([[dict objectForKey:@"feed_type"] intValue]==30)
        {
            ...
            NewFeedUploadPhoto* data = [NewFeedUploadPhoto insertNewFeed:0   getDate:_currentTime  Owner:self.processRenrenUser  Dic:dict inManagedObjectContext:self.managedObjectContext];
            
            [self.processRenrenUser addNewFeedObject:data]; 
        }
        else if ([[dict objectForKey:@"feed_type"] intValue]==33)
        {
            NewFeedShareAlbum* data = [NewFeedShareAlbum insertNewFeed:0  height:scrollHeight getDate:_currentTime  Owner:self.processRenrenUser  Dic:dict inManagedObjectContext:self.managedObjectContext];
        ...
        else if ([[dict objectForKey:@"feed_type"] intValue]==32)
        {
            ...
            //   NSLog(@"%@",dict);
            NewFeedSharePhoto* data = [NewFeedSharePhoto insertNewFeed:0    height:scrollHeight  getDate:_currentTime  Owner:self.processRenrenUser  Dic:dict inManagedObjectContext:self.managedObjectContext];
            
            [self.processRenrenUser addNewFeedObject:data]; 
        }
        else
        {
            NewFeedData* data = [NewFeedData insertNewFeed:0  height:scrollHeight getDate:_currentTime  Owner:self.processRenrenUser  Dic:dict inManagedObjectContext:self.managedObjectContext];
